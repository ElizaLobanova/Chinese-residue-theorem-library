...
Основой алгоритма является Китайская теорема об остатках:

Пусть $n = n_1 n_2 ... n_k$, где $n_i$ попарно взаимно простые натуральные числа

\subsection{Разбиение большого числа на составные части}



Чтобы разложить число X на остатки $r_i$ необходимо найти остаток от деления на такой набор простых чисел $a_i$ чтобы $\prod\limits_{i=1}^n a_i \geqslant X$
