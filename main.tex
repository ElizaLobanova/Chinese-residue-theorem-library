...
Hao Y. et al. Cambricon-p: A bitflow architecture for arbitrary precision computing //2022 55th IEEE/ACM International Symposium on Microarchitecture (MICRO). – IEEE, 2022. – С. 57-72. \\

\bibitem{makarova2023canonical}
Makarova K. et al. Canonical Monte Carlo multispin cluster method //Journal of Computational and Applied Mathematics. – 2023. – Т. 427. – С. 115153.\\

\bibitem{trukhin2024thermodynamic}
Trukhin V. O. et al. Thermodynamic equilibrium of±J Ising model on square lattice //Physica A: Statistical Mechanics and its Applications. – 2024. – Т. 655. – С. 130172.\\

\bibitem{trukhin2025low}
Trukhin V. O. et al. Low-temperature states of the Ising±J model on a square lattice //Physica A: Statistical Mechanics and its Applications. – 2025. – С. 130729.\\

\bibitem{Vasiliev2020Numerical}
Васильев Е. В. и др. Численное моделирование двумерных магнитных скирмионных структур //Компьютерные исследования и моделирование. – 2020. – Т. 12. – №. 5. – С. 1051-1061.\\
...
Omondi A. R., Premkumar A. B. Residue number systems: theory and implementation. – World Scientific, 2007. – Т. 2.\\

\bibitem{soderstrand1986residue}
Soderstrand M. A. et al. (ed.). Residue number system arithmetic: modern applications in digital signal processing. – IEEE press, 1986.\\

\bibitem{trukhin2025alg}
Трухин В. О. и др. Переборный алгоритм декомпозиции для решения модели Изинга //Дальневосточный математический журнал. – 2025. – Т. 25. – №. 1. – С. 102-112.\\
