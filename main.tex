...
Практическая значимость работы определяется тем, что предложенный подход может служить вычислительным ядром для широкого класса задач, где критическими являются одновременно большая разрядность данных и высокая степень параллелизма: численного моделирования физических систем, криптографических приложений, переборных алгоритмов и других вычислительно трудоёмких исследований.
