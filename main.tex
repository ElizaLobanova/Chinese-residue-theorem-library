...
Существует несколько подходовподходов к выбору простых чисел для разбиения. 
...
В следствии того, что $r_i \in (\mathbb{N} \cup 0) $, операция деления не определена для модульной арифметики в явном виде.
