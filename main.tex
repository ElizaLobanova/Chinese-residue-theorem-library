...
На рисунке \ref{fig:timeTest} представлена производительность операции сложения массивов чисел фиксированной разрядности порядка $2^{100}$. По оси абсцисс отложена длина массива (число обрабатываемых элементов), по оси ординат — производительность, выраженная в числе операций сложения в секунду, в логарифмическом масштабе.
