...
На рисунке \ref{fig:timeTest} представлена производительность операции сложения на одном потоке.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{images/time.pdf}
	\caption{Производительность операции сложения на одном потоке.}
	\label{fig:timeTest}
\end{figure}
