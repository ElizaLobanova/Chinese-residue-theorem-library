...
Одним из перспективных направлений является использование модульной арифметике, основанной на китайской теореме об остатках (КТО). Представление числа в виде набора независимых вычетов по взаимно простым модулям позволяет заменить операции над многобайтными целыми числами на совокупность более простых модульных операций фиксированной разрядности. Такая форма записи естественным образом согласуется с архитектурой GPU, где вычисления выполняются большим числом потоков над компактными типами данных. Несмотря на известность КТО в вычислительной математике, её потенциал как инструмента организации массового параллелизма в задачах длинной арифметики остаётся недостаточно исследованным применительно к современным ускорительным архитектурам.

Настоящая работа направлена на устранение указанного разрыва между теоретически известными свойствами системы остаточных классов и практическими требованиями высокопроизводительных вычислений. В ней предлагается алгоритмическая схема выполнения арифметических операций с числами большой разрядности, адаптированная к параллельной реализации на GPU, а также анализируются особенности выбора модульного базиса, восстановления результата и влияния этих факторов на производительность.

Практическая значимость работы определяется тем, что предложенный подход может служить вычислительным ядром для широкого класса задач, где критическими являются одновременно большая разрядность данных и высокая степень параллелизма: численного моделирования физических систем, криптографических приложений, переборных алгоритмов и других вычислительно трудоёмких исследований. Тем самым результаты интегрируются в современную парадигму high-performance computing, ориентированную на алгоритмы, изначально спроектированные под массово-параллельные архитектуры.
